    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 1g:px-24 x1:px-32">
      ...
      <div>
        <div className="filex flex-col items-start text-left">
          <h1 className="font-playfair text-4x] md:text-[40px]">Hotel Rooms For you</h1>
          <p ClassName="text-sm md:text-base text-gray-500/90 mt-2 max-w-174">
            Take advantage of our limited-time offers and special packages to enhance your stay and create Lasting memories.
          </p>
        </div>
