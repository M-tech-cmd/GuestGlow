...
const Hero = () => {
  ...
  useEffect(() => {
    // Extract unique cities from rooms data
  ...
  const onSearch = async (e) => {
    ...
    // Check if destination exists in availableCities
    if (!availableCities.includes(destination)) {
    ...
    // Update local searchedCities (max 3)
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      <p className="bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20 w-fit">
      ...
      <p className="max-w-130 mt-2 text-sm md:text-base">
        Luxurious comfort awaits at the world's most exclusive hotels and resorts. Start your journey today.
      </p>
